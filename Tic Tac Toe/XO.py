...
def play_click_sound():
    ...
    cs_4 = pygame.mixer.Sound("woodblock.wav")
    if clickchoice == 1:
        cs_1.play()
    elif clickchoice == 2:
        cs_2.play()
...
def play_bgmusic():
    global bgmchoice
    bgmchoice = 1
    bg_1 = pygame.mixer.Sound("Jazz.wav")
    bg_2 = pygame.mixer.Sound("Gravity_Falls_8_bit.wav")
    bg_3 = pygame.mixer.Sound("Flymetothemoon.wav")
    if bgmchoice == 1:
        bg_1.play(-1)
    elif bgmchoice == 2:
        bg_2.play(-1)
...
class CREDIT():
    ...
    def __init__(self, master):
        ...
        self.master.geometry("960x500")
        self.master.iconbitmap('logo.ico')
        self.master.resizable(0, 0)
        # =================
        self.canvas = Canvas(self.master, width=200, height=200)
        self.canvas.pack(fill=BOTH, expand=1)
        self.img = ImageTk.PhotoImage(PIL.Image.open("nice.png"))
        self.canvas.create_image(0, 0, anchor=NW, image=self.img)

        count = 50

        self.text = Label(self.canvas, text="", font=("Helvetica", 23), foreground="black", background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="- Introduction to Information Technology 2 -", font=("Helvetica", 23),
                          foreground="orange", background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="< INSTRUCTION TEACHER >", font=("Cambria", 17), foreground="turquoise",
                          background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="Dr. Le Nguyen Hoai Nam", font=("Comic Sans MS", 13), foreground="white",
                          background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="MS. Do Thi Thanh Ha", font=("Comic Sans MS", 13), foreground="white",
                          background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="< THE ROYAL-T TEAM >", font=("Cambria", 17), foreground="turquoise",
                          background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="Tran Huy Vu - 18127257", font=("Comic Sans MS", 13), foreground="white",
                          background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="Tran Phuoc Loc - 18127130", font=("Comic Sans MS", 13), foreground="white",
                          background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="Tran Bui Tai Nhan - 18127168", font=("Comic Sans MS", 13),
                          foreground="white", background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="Trinh Minh Thanh - 18127217", font=("Comic Sans MS", 13),
                          foreground="white", background="black")
        self.text.pack()
        self.text = Label(self.canvas, text="Phan Tan Dat - 18127078", font=("Comic Sans MS", 13), foreground="white",
                          background="black")
        self.text.pack()
        self.button = Button(self.master, text="Back to menu", command=self.quit)
        button_window = self.canvas.create_window(445, 400, anchor='nw', window=self.button)
